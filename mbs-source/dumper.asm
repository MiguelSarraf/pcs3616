...
LOOP            LD      COUNT        ; Carrega o num. de words que já foram escritas
                SB      DUMP_TAM     ; Subtrai o tamanho total do arquivo
                ...
                ML      TWO          ;
                AD      DUMP_INI     ; ACC = Endereço da próxima word que será escrita
WRITE4          $       /0001        ; Escreve no arquivo de saída
                AD      CHECKSUM     ; Atualiza CHECKSUM
                MM      CHECKSUM     ; Armazena CHECKSUM atualizado
                LD      DUMP_TAM     ;
                SB      COUNT        ;
                SB      DUMP_BL      ;
                JN      SUM_DUMP_BL  ; if ((DUMP_TAM SBCOUNT SBDUMP_BL) < 0) goto SUM_DUMP_BL
                LD      DUMP_BL      ;
                JP      WRITE5
SUM_DUMP_BL     AD      DUMP_BL
