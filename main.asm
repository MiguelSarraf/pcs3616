...
EX              K /4558 ; EX em ASCII
TKFIM           K /2F2A ; /MLem ASCII
...
CMDOUEND        SC PEGADADO          ; Leio mais um dado
                SB FIMARQ            ; Comparo com o fim de arquivo
...
TRATAOPEX       K  /0000
                ...
                MM END_EXE          ; End. retorno no AC. Grava no endereço de execução
                DV MIL              ; Divide por 1000
                ML MIL              ; Multiplica por 1000
                JZ CERTOEX          ; É um endereço válido do tipo 0xxx
                JP ERROEX           ; Deu erro: end. inválido
CERTOEX         SC PEGADADO         ; Espera-se ler um /n/n
                SC CHECAPULA        ; Verifica se o comando é válido
                JZ ERROCMD          ; Se não tiver um pula deu erro de cmd.
                LV END_EXE          ; Joga para o acumulador o end de execução
